...
export const animationProjects = [
  {
    ...
    title: "The Darkroom",
    year: "—",
    discipline: "3D Animation / Psychological Narrative",
    image: "/projects/3d-animation/the-darkroom.jpg",
    animationType: "3D Animation",
    duration: "9 minutes",
    aesthetic: "Photorealism",
    note: "",
    summary:
      "This animation tells the story of a hitman who, during a contracted mission, accidentally kills a child, plunging him into endless guilt. The heart of the narrative lies in his entrapment within a psychological loop, where he repeatedly relives the murder through a first-person perspective while witnessing his third-person self committing the act—a torment that drives him to unbearable pain. To escape this nightmare, he enters a dark, surreal dark-room world, searching for a way out.",
    link: "https://www.youtube.com/watch?v=hKhr-XMGUwY",
  },
  {
    slug: "the-liberation",
    title: "The Liberation",
    year: "—",
    discipline: "3D Animation / VFX Motion Track",
    image: "/projects/3d-animation/the-liberation.jpg",
    animationType: "3D Animation + VFX Motion Track",
    duration: "3 minutes",
    aesthetic: "Photorealism",
    note: "Music collaboration with Steven Tsang’s track “Trash.”",
    summary:
      "This animation is an abstract 3D music visualization created in collaboration with Steven Tsang’s music “Trash.” It explores the journey of a soul trapped in the endless cycle of birth, death and rebirth—a cycle it longs to escape. Through rhythm, motion and surreal forms, the film expresses the inner tension between existence and liberation.",
    link: "https://youtu.be/gQRHrJw3Uyw?si=mVrl8sd_Epk0tqHh",
  },
  {
    slug: "modify-him",
    title: "Modify Him",
    year: "—",
    discipline: "Character Animation / 3D Film",
    image: "/projects/3d-animation/modify-him.jpg",
    animationType: "3D Animation",
    duration: "4 minutes",
    aesthetic: "Pixar Style",
    note: "12th Animation Support Program work.",
    summary:
      "There was a mischievous child named Billie who loved to mess with computers despite repeated warnings from adults. One day, he sneaked into his aunt’s studio to cause trouble. Grey, an animated character inside the computer, gained self-awareness and began to fight back using features of the 3D animation software. In the end, Billie was defeated and transformed into a 3D file, never able to cause mischief again.",
    link: "https://youtu.be/eTCzMOZBDIk?si=iqNwvWKgOHk2se_V",
  },
  {
    slug: "billies-escape-airpod",
    title: "Billy’s Escape AirPods",
    year: "—",
    discipline: "Character Animation / 3D Film",
    image: "/projects/3d-animation/billies-escape-airpod.jpg",
    animationType: "3D Animation",
    duration: "3 minutes",
    aesthetic: "Pixar Style",
    note: "",
    summary:
      "Billy never cleaned his ears and remained completely unaware of the problem. Over time, his AirPods accumulated a significant amount of earwax. Finally, one of the AirPods made the decision to escape.",
    link: "https://www.youtube.com/watch?v=zNJBjTwiFuI",
  },
  {
    slug: "fragments-of-memory",
    title: "Fragments of Memory",
    year: "2026",
    discipline: "AI Film / Cinematic Visual",
    image: "/projects/3d-animation/fragments-of-memory.jpg",
    animationType: "AIGC Film",
    duration: "4 minutes 20 seconds",
    aesthetic: "Minimal / Tranquil / Cinematic",
    note: "",
    summary:
      "“Fragments of Memory” asks: death is not the end of life—forgetting is. When love is taken by time, memory becomes the way to exist. Through minimal and tranquil imagery, the film depicts a soul retracing its past—finding warmth within what is lost and learning to make peace with eternity.",
    link: "https://www.youtube.com/watch?v=c60CtkEeg4M",
  },
  {
    slug: "doraemon-animation-fanmade",
    title: "Doraemon Animation (Fanmade)",
    year: "2024",
    discipline: "3D Animation / Fanmade Film",
    image: "/projects/3d-animation/doraemon-animation-fanmade.jpg",
    animationType: "3D Animation",
    duration: "3 minutes",
    aesthetic: "Pixar Style",
    note: "",
    summary: "Project story, process and production details will be added here.",
    link: "",
  },
] as const;
