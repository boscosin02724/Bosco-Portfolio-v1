...
import { djSnakeCaseStudy } from "../data/portfolio";
import { CaseNav } from "./CaseNav";

const caseStudy = djSnakeCaseStudy;

export function DjSnakeProjectPage() {
  return (
    <div className="case-page dj-snake-case bg-paper text-ink selection:bg-accent selection:text-white">
      <CaseNav />
      ...
      <main>
        ...
        <section className="case-section case-concept">
          <div>
            <p className="case-eyebrow">Creative Focus</p>
            <h2>AI-generated city-scale visuals built for live energy, OOH impact and social momentum.</h2>
          </div>
        ...
        <section className="case-section case-gallery-section">
          <div className="case-section-heading">
            ...
            <h2>Concert, skyline and OOH moments composed as one cinematic campaign language.</h2>
          </div>
        ...
        <section className="case-section case-contribution">
          <div>
            ...
            <h2>
              I shaped the AI visual direction, campaign simulations and motion content system, turning event concepts into
              high-impact promotional imagery.
            </h2>
          </div>
