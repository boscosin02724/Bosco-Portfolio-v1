...
import { mplusCaseStudy } from "../data/portfolio";
import { CaseNav } from "./CaseNav";

const caseStudy = mplusCaseStudy;

export function MplusProjectPage() {
  return (
    <div className="case-page mplus-case bg-paper text-ink selection:bg-accent selection:text-white">
      <CaseNav />
      ...
      <main>
        ...
        <section className="case-section case-concept">
          <div>
            <p className="case-eyebrow">Design Direction</p>
            <h2>A contemporary cultural gala shaped through light, flow and hospitality.</h2>
          </div>
        ...
        <section className="case-section case-gallery-section">
          <div className="case-section-heading">
            ...
            <h2>Event zones composed as a cinematic guest journey.</h2>
          </div>
        ...
        <section className="case-section case-contribution">
          <div>
            ...
            <h2>
              I developed the event concept, spatial journey and presentation visuals, translating the M+ Gala tender into a clear
